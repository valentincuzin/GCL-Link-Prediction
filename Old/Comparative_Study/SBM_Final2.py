...
def LFR_gen():
    G = LFR_benchmark_graph(400, 2.5, 2.5, 0.2, average_degree=10, min_community=200, max_community=200, seed=10)
...
df.to_csv(f'output/SBM_mlp_400_res_2_commu_deplete.csv', sep=';')
